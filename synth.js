...
var isMobile = true;	// we have to disable the convolver on mobile for performance reasons.
...
function initAudio() {
	...
	isMobile = false && (navigator.userAgent.indexOf("Android")!=-1)||(navigator.userAgent.indexOf("iPad")!=-1)||(navigator.userAgent.indexOf("iPhone")!=-1);
  ...
  //   if (!isMobile) {
	...
	// 	irRRequest.send();
	// }
	loadMultiPatchFile( "mypatches.json", loadMultiPatchJSONObject );
}
